...
(
	...
	CONSTRAINT [FK_dbo.Item_Seller] FOREIGN KEY (SellerID) REFERENCES dbo.Artist (SellerID)
);
...
(
	...
	CONSTRAINT [FK_dbo.Bid_Buyer] FOREIGN KEY (BuyerID) REFERENCES dbo.Genre (BuyerID)
);
