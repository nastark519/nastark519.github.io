...
(
	...
	CONSTRAINT [PF_dbo.Classification_ArtWork] FOREIGN KEY ([ArtWKey])
	REFERENCES dbo.ArtWork ([ArtWKey]),
	CONSTRAINT [PF_dbo.Classification_Genre] FOREIGN KEY ([GenreKey])
